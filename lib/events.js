 ...
 * @module lib/events
 *
 * Pug javascript locals and utilities for events pages. This file does not get
 * reloaded via gulp-watch. If it changes, be sure to restart gulp.
 */
 ...
 */
const isSameDay = exports.isSameDay = function (d1, d2) {  // eslint-disable-line
 ...
 */
const isPastEvent = exports.isPastEvent = function (e) {  // eslint-disable-line
 ...
 */
const compareEventTimes = exports.compareEventTimes = function (e1, e2) {  // eslint-disable-line
